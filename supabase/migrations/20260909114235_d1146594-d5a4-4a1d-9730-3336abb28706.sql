ALTER TABLE public.booking_requests ALTER COLUMN start_date DROP NOT NULL;
ALTER TABLE public.booking_requests ADD COLUMN IF NOT EXISTS rental_start_date date;
ALTER TABLE public.booking_requests ADD COLUMN IF NOT EXISTS rental_end_date date;
ALTER TABLE public.booking_requests ADD COLUMN IF NOT EXISTS rental_duration text;
...
ALTER TABLE public.booking_requests ADD CONSTRAINT booking_requests_status_check
  CHECK (status = ANY (ARRAY['pending','approved','on_rent','completed','cancelled','sold']));
