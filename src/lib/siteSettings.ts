...
export const DEFAULT_SETTINGS: Omit<SiteSettings, 'id' | 'created_at' | 'updated_at'> = {
  logo_url: null,
  brand_name: 'Baby Carrier Rental',
  ...
  whatsapp_number: '919953398411',
  whatsapp_message: 'Hi! I am interested in renting a baby carrier.',
  email: null,
  instagram_url: null,
  hero_title: 'Baby Carrier Rental & Sling Library',
  ...
  hero_cta_link: '/category/ring-slings',
  features: [
  ...
  menu_items: [
    ...
    { name: 'Soft Structured Carriers', href: '/?type=buckle-carriers#browse-all' },
    { name: 'Policies', href: '/policies' },
    { name: 'Safety', href: '/safety' },
  ],
  footer_description: 'Try before you buy! We offer premium baby carriers for weekly and monthly rental. Perfect for finding the right carrier for you and your little one.',
  footer_links: [
  ...
  meta_description: 'Rent premium baby carriers in India. Try before you buy with our curated collection of ring slings, wraps, and soft structured carriers.',
