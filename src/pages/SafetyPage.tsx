    ...
    return (
      <Layout>
        ...
        <div className="container py-12 max-w-3xl">
          <div
            className="prose prose-neutral max-w-none space-y-8 [&_section]:mb-8 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:mb-4 [&_p]:text-muted-foreground [&_ul]:space-y-2 [&_li]:text-muted-foreground"
      ...
      <div className="container py-12 max-w-3xl">
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {ticks.map((item) =>
            <div key={item.letter} className="flex items-start gap-4 p-4 rounded-xl bg-secondary">
